...
class AdjListGraph:
  ...
  def edges(self):
    ...
    for secondary_map in self._outgoing.values():
      result.update(secondary_map)    # add edges to resulting set
    return result
  ...
  def insert_vertex(self, x=None):
    ...
    v = self.Vertex(x)
    self._outgoing[v] = deque()
    if self.is_directed():
      self._incoming[v] = deque()        # need distinct map for incoming edges
    return v
